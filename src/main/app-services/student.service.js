...
function StudentService($http) {
    var service = {};
    const configUrl = location.protocol + "//" + location.hostname + ":" + 8080 + '/api/students/';
    const deleteStudentConfigUrl = location.protocol + "//" + location.hostname + ":" + 8080 + '/api/delete/student/';
